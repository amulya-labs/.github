...
- **Speed** (build/test/CI iteration loops)
- **Operational simplicity** (boring-by-default)
- **Portability** (avoid lock-in)
- **Clarity** (docs that don’t waste time)

---

## Contributing

Most repos accept issues + PRs.
- If a repo has `CONTRIBUTING.md`, follow it.
- If not, keep PRs small, focused, and well-explained.

---

## Security

If you find a security issue, follow the instructions in `SECURITY.md` in the relevant repository (or the org default, if present).

---

## License

Each repository defines its own license — see the `LICENSE` file in that project.
